...
var abc="https://investor.Nodeberry.io";
...
//   browser = 'Unknown';
     ...
     var os=req.body.os;
    // var abc="https://investor.Nodeberry.io/reset/?token="+token;
    ...
    var mailOptions = {
      to: email,
      from: '"Nodeberry"<support@Nodeberry.io>',
      ...
      <html><head>
       ...
       <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
         ...
         <div id="main-header"> 
         <h2><img src="https://www.Nodeberry.io/image/favicon.png" class="img-logo"></h2> </div>
      <div id="main-body"> <div id="modal">
       <div id="modal-header"> 
       
       <h2>Successful Login</h2> </div><hr> <div id="modal-body"> 
       <p>Dear User,</p><br><p style="text-align:justify"> An attempt to login to your Nodeberry Investor Portal was made.</p><br>
     
      <p style="text-align:justify">If its not you,change your password immediately or please contact our Support Team by replying directly to this message or email us at technical@Nodeberry.io</p>
      <br><br><p>Sincerely,<br>Tech Team,<br>Nodeberry BTR LLC</p></div></div><br><br><hr> <p style="text-align:center;font-size:1em">&copy;Nodeberry BTR LLC<br>3620 Piedmont RD NE, <br>Suite B-4122,Atlanta,Georgia - 30305</p></div></div></div></div></body></html>`               
    };
     ...
     if(isdone.is_kyc_done && isdone.is_kyc_verified && isdone.is_aml_done)
      return res.send({success:"true",uuid:isdone.uuid});
      ...
      function(token, user, done) {
        ...
        var abc="https://investor.Nodeberry.io/reset/?token="+token;
         var mailOptions = {
          ...
          html:`<!DOCTYPE html><html><head> <title>Greyz BTR Coin</title> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <meta charset="utf-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <style>.btn{display: inline-block; *display: inline; *zoom: 1; padding: 4px 10px 4px; margin-bottom: 0; font-size: 13px; line-height: 18px; color: #333333; text-align: center; text-shadow: 0 1px 1px rgba(255, 255, 255, 0.75); vertical-align: middle; background-color: #f5f5f5;}.btn-large{padding: 9px 14px; font-size: 15px; line-height: normal; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; max-width:50%; margin-left:20%}.btn:hover{color: #333333; text-decoration: none; background-color: #ff3f3f; background-position: 0 -15px; -webkit-transition: background-position 0.1s linear; -moz-transition: background-position 0.1s linear; -ms-transition: background-position 0.1s linear; -o-transition: background-position 0.1s linear; transition: background-position 0.1s linear;}.btn-primary, .btn-primary:hover{text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); color: #ffffff;}.btn-primary.active{color: rgba(255, 255, 255, 0.75);}.btn-primary{background-image: linear-gradient(224deg,#3c54a4 14%,#0f73ee 100%); box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2), 0 1px 2px rgba(0, 0, 0, 0.5);}.btn-primary:hover, .btn-primary:active, .btn-primary.active, .btn-primary.disabled, .btn-primary[disabled]{filter: none; background-color: white; color: #3c54a4;}.btn-block{width: 100%; display: block;}.btn-rr{border-radius: 0.2em;}*{margin: 0; padding: 0; -webkit-box-sizing: border-box; -ms-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;}a{text-decoration: none;}html{height: 100vh; width: 100%;}body{font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif; font-size: 3em; color: #333; background: #ee0979; /* fallback for old browsers */ background-image: -webkit-linear-gradient(to bottom right, rgba(243, 90, 70, 0.97), rgba(238, 9, 121, 0.97)); /* Chrome 10-25, Safari 5.1-6 */ background-image: linear-gradient(to bottom right, rgba(255, 106, 0, 0.97), rgba(238, 9, 121, 0.97)); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */ height: 100vh; width: 100%;}.main{color: #3c54a4; font-weight: bold;}p{font-size:18px; color:black; text-align: justify;}.main:hover{color: rgb(1, 193, 252);}.light{color: #fff;}.main-container{width: 75%; height: 100%; position: relative; margin: 2em auto; background-color: #eee;}.row{width: 100%; display: flex; flex-wrap: wrap;}.col-1{width: 8.33%;}.col-2{width: 16.67%;}.col-3{width: 25%;}.col-4{width: 33.33%;}.col-5{width: 41.67%}.col-6{width: 50%;}.col-7{width: 58.33%;}.col-8{width: 66.67%;}.col-9{width: 75%;}.col-10{width: 83.33%;}.col-11{width: 91.67%;}.col-12{width: 100%;}html{}.img-logo{max-width: 10%; height: auto;}.main-container h2{text-align: center;}#main-header{padding: 30px 0;}#modal{width: 90%; position: relative; padding: 1.5em; font-size: 1.7em; margin: 0 auto; background-color: #fff; border-radius: 10px;}#modal-header{padding: 30px 0; color:#3c54a4;}#modal-footer a{width: 80%; position: relative; margin: 30px auto;}#modal-body{padding: 2em; color:black;}a button{width: 100%; text-align: center; font-size: 14px;}#modal-footer{text-align: center; font-size:14px;}.highlight{font-weight: bolder; font-size: 30px;}@media only screen and (max-width:770px){#modal{width: 100%; font-size: 1.2em;}.main-container{width: 100%;}.img-logo{max-width: 20%;}#modal-body{padding: 0.5em;}#btn-large{max-width: 100%; margin-left:0;}}</style></head><body> <div class="main-container"> <div id="main-header"> <h2><img src="https://www.Nodeberry.io/image/favicon.png" class="img-logo"></h2> </div><div id="main-body"> <div id="modal"> <div id="modal-header"> <h2>Reset Password</h2> </div><hr> <div id="modal-body"> <p>Dear User,</p><br><p style="text-align:justify"> You recently requested to reset your Nodeberry Investor Portal account password.</p><br><a href="${abc}"><button class='btn btn-large btn-primary btn-rr'>Reset Now</button><br><br><p style="text-align:justify">To receive more help on this issue, please contact our Support Team by replying directly to this message or reach us at technical@Nodeberry.io<br><br><p>Sincerely,<br>Tech Team,<br>Nodeberry BTR LLC</p></div><br><br><hr> <p style="text-align:center;font-size:0.7em">&copy;Nodeberry BTR LLC<br>3620 Piedmont RD NE, <br>Suite B-4122,Atlanta,Georgia - 30305</p></div></div></div></div></body></html>`
           };
        ...
        User.findOne({ resetPasswordToken: req.body.token, resetPasswordExpires: { $gt: Date.now() } }, async function(err, user) {
          ...
          if(req.body.new === req.body.confirm) {
            ...
            console.log(user.password);
              ...
              await user.save();
              const html = `<!DOCTYPE html><html><head> <title>Greyz BTR Coin</title> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <meta charset="utf-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <style>.btn{display: inline-block; *display: inline; *zoom: 1; padding: 4px 10px 4px; margin-bottom: 0; font-size: 13px; line-height: 18px; color: #333333; text-align: center; text-shadow: 0 1px 1px rgba(255, 255, 255, 0.75); vertical-align: middle; background-color: #f5f5f5;}.btn-large{padding: 9px 14px; font-size: 15px; line-height: normal; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; max-width:50%; margin-left:20%}.btn:hover{color: #333333; text-decoration: none; background-color: #ff3f3f; background-position: 0 -15px; -webkit-transition: background-position 0.1s linear; -moz-transition: background-position 0.1s linear; -ms-transition: background-position 0.1s linear; -o-transition: background-position 0.1s linear; transition: background-position 0.1s linear;}.btn-primary, .btn-primary:hover{text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); color: #ffffff;}.btn-primary.active{color: rgba(255, 255, 255, 0.75);}.btn-primary{background-image: linear-gradient(224deg,#3c54a4 14%,#0f73ee 100%); box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2), 0 1px 2px rgba(0, 0, 0, 0.5);}.btn-primary:hover, .btn-primary:active, .btn-primary.active, .btn-primary.disabled, .btn-primary[disabled]{filter: none; background-color: white; color: #3c54a4;}.btn-block{width: 100%; display: block;}.btn-rr{border-radius: 0.2em;}*{margin: 0; padding: 0; -webkit-box-sizing: border-box; -ms-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;}a{text-decoration: none;}html{height: 100vh; width: 100%;}body{font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif; font-size: 3em; color: #333; background: #ee0979; /* fallback for old browsers */ background-image: -webkit-linear-gradient(to bottom right, rgba(243, 90, 70, 0.97), rgba(238, 9, 121, 0.97)); /* Chrome 10-25, Safari 5.1-6 */ background-image: linear-gradient(to bottom right, rgba(255, 106, 0, 0.97), rgba(238, 9, 121, 0.97)); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */ height: 100vh; width: 100%;}.main{color: #3c54a4; font-weight: bold;}p{font-size:18px; color:black; text-align: justify;}.main:hover{color: rgb(1, 193, 252);}.light{color: #fff;}.main-container{width: 75%; height: 100%; position: relative; margin: 2em auto; background-color: #eee;}.row{width: 100%; display: flex; flex-wrap: wrap;}.col-1{width: 8.33%;}.col-2{width: 16.67%;}.col-3{width: 25%;}.col-4{width: 33.33%;}.col-5{width: 41.67%}.col-6{width: 50%;}.col-7{width: 58.33%;}.col-8{width: 66.67%;}.col-9{width: 75%;}.col-10{width: 83.33%;}.col-11{width: 91.67%;}.col-12{width: 100%;}html{}.img-logo{max-width: 10%; height: auto;}.main-container h2{text-align: center;}#main-header{padding: 30px 0;}#modal{width: 90%; position: relative; padding: 1.5em; font-size: 1.7em; margin: 0 auto; background-color: #fff; border-radius: 10px;}#modal-header{padding: 30px 0; color:#3c54a4;}#modal-footer a{width: 80%; position: relative; margin: 30px auto;}#modal-body{padding: 2em; color:black;}a button{width: 100%; text-align: center; font-size: 14px;}#modal-footer{text-align: center; font-size:14px;}.highlight{font-weight: bolder; font-size: 30px;}@media only screen and (max-width:770px){#modal{width: 100%; font-size: 1.2em;}.main-container{width: 100%;}.img-logo{max-width: 20%;}#modal-body{padding: 0.5em;}#btn-large{max-width: 100%; margin-left:0;}}</style></head><body> <div class="main-container"> <div id="main-header"> <h2><img src="https://www.Nodeberry.io/image/favicon.png" class="img-logo"></h2> </div><div id="main-body"> <div id="modal"> <div id="modal-header"> <h2>Reset Successful</h2> </div><hr> <div id="modal-body"> <p>Dear User,</p><br><p style="text-align:justify">You have successfully reset the password for your Nodeberry BTR LLC investor portal</p><br><br><p style="text-align:justify">If you haven't done this, please contact our Support Team by replying directly to this message.</p></div><br><br><hr> <p style="text-align:center;font-size:0.5em">&copy;Nodeberry BTR LLC</p></div></div></div></div></body></html>`
              // Send email
          await mailer.sendEmail('"Nodeberry"<support@Nodeberry.io>', user.email, 'Confirmation email!', html);
      console.log("mail sent !");
...
router.route('/verify')
  ...
  .post(async (req, res)=> {
     ...
     const html = `<!DOCTYPE html><html><head> <title>Greyz BTR Coin</title> <meta name="viewport" content="width=device-width, initial-scale=1.0"> <meta charset="utf-8"> <meta http-equiv="X-UA-Compatible" content="IE=edge"> <style>.btn{display: inline-block; *display: inline; *zoom: 1; padding: 4px 10px 4px; margin-bottom: 0; font-size: 13px; line-height: 18px; color: #333333; text-align: center; text-shadow: 0 1px 1px rgba(255, 255, 255, 0.75); vertical-align: middle; background-color: #f5f5f5;}.btn-large{padding: 9px 14px; font-size: 15px; line-height: normal; -webkit-border-radius: 5px; -moz-border-radius: 5px; border-radius: 5px; max-width:50%; margin-left:20%}.btn:hover{color: #333333; text-decoration: none; background-color: #ff3f3f; background-position: 0 -15px; -webkit-transition: background-position 0.1s linear; -moz-transition: background-position 0.1s linear; -ms-transition: background-position 0.1s linear; -o-transition: background-position 0.1s linear; transition: background-position 0.1s linear;}.btn-primary, .btn-primary:hover{text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25); color: #ffffff;}.btn-primary.active{color: rgba(255, 255, 255, 0.75);}.btn-primary{background-image: linear-gradient(224deg,#3c54a4 14%,#0f73ee 100%); box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.2), 0 1px 2px rgba(0, 0, 0, 0.5);}.btn-primary:hover, .btn-primary:active, .btn-primary.active, .btn-primary.disabled, .btn-primary[disabled]{filter: none; background-color: white; color: #3c54a4;}.btn-block{width: 100%; display: block;}.btn-rr{border-radius: 0.2em;}*{margin: 0; padding: 0; -webkit-box-sizing: border-box; -ms-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;}a{text-decoration: none;}html{height: 100vh; width: 100%;}body{font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Oxygen, Ubuntu, Cantarell, "Open Sans", "Helvetica Neue", sans-serif; font-size: 3em; color: #333; background: #ee0979; /* fallback for old browsers */ background-image: -webkit-linear-gradient(to bottom right, rgba(243, 90, 70, 0.97), rgba(238, 9, 121, 0.97)); /* Chrome 10-25, Safari 5.1-6 */ background-image: linear-gradient(to bottom right, rgba(255, 106, 0, 0.97), rgba(238, 9, 121, 0.97)); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */ height: 100vh; width: 100%;}.main{color: #3c54a4; font-weight: bold;}p{font-size:18px; color:black; text-align: justify;}.main:hover{color: rgb(1, 193, 252);}.light{color: #fff;}.main-container{width: 75%; height: 100%; position: relative; margin: 2em auto; background-color: #eee;}.row{width: 100%; display: flex; flex-wrap: wrap;}.col-1{width: 8.33%;}.col-2{width: 16.67%;}.col-3{width: 25%;}.col-4{width: 33.33%;}.col-5{width: 41.67%}.col-6{width: 50%;}.col-7{width: 58.33%;}.col-8{width: 66.67%;}.col-9{width: 75%;}.col-10{width: 83.33%;}.col-11{width: 91.67%;}.col-12{width: 100%;}html{}.img-logo{max-width: 10%; height: auto;}.main-container h2{text-align: center;}#main-header{padding: 30px 0;}#modal{width: 90%; position: relative; padding: 1.5em; font-size: 1.7em; margin: 0 auto; background-color: #fff; border-radius: 10px;}#modal-header{padding: 30px 0; color:#3c54a4;}#modal-footer a{width: 80%; position: relative; margin: 30px auto;}#modal-body{padding: 2em; color:black;}a button{width: 100%; text-align: center; font-size: 14px;}#modal-footer{text-align: center; font-size:14px;}.highlight{font-weight: bolder; font-size: 30px;}@media only screen and (max-width:770px){#modal{width: 100%; font-size: 1.2em;}.main-container{width: 100%;}.img-logo{max-width: 20%;}#modal-body{padding: 0em;}#btn-large{max-width: 100%; margin-left:0;}}</style></head><body> <div class="main-container"> <div id="main-header"> <h2><img src="https://www.Nodeberry.io/image/favicon.png" class="img-logo"></h2> </div><div id="main-body"> <div id="modal"> <div id="modal-header"> <h2>Transaction Successful</h2> </div><hr> <div id="modal-body"> <p>Dear User,</p><br><p style="text-align:justify">Your transaction have been submitted successfully. Kindly verify the following details. As this transaction is already confirmed on the blockchain it cannot be reverted or stopped.</p><br><p><b>Receiver:</b>${to} <br> <b>Amount:</b>${amount} </p><br><p style="text-align:justify">If you haven't done this transaction, please contact our Support Team by replying directly to this message or contact us at technical@Nodeberry.io<br><br><p>Sincerely,<br>Tech Team,<br>Nodeberry BTR LLC</p></div><br><br><hr> <p style="text-align:center;font-size:0.5em">&copy;Nodeberry BTR LLC<br>3620 Piedmont RD NE, <br>Suite B-4122,Atlanta,Georgia - 30305</p></div></div></div></div></body></html>`
              // Send email
     mailer.sendEmail('"Nodeberry"<support@Nodeberry.io>', user.email, 'Transaction Alert!', html);
    });
